<?php /* Smarty version 2.6.26, created on 2013-08-05 07:28:04
         compiled from admin_edit.tpl */ ?>
...
<td width="69%"><input type="text" style=" width:200px; background-color:#CCCCCC;" name='admin_id' value="<?php echo $this->_tpl_vars['arr']['admin_id']; ?>
" readonly='readonly'/></td>
</tr>
<tr>
<td align="right"><strong>管理姓名：</strong></td>
<td><input type="text" name="admin_name" size="45" value="<?php echo $this->_tpl_vars['arr']['admin_name']; ?>
"/></td>
</tr>
<tr>
