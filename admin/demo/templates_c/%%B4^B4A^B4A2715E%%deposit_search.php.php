<?php /* Smarty version 2.6.26, created on 2013-07-30 10:05:46
         compiled from deposit_search.php */ ?>
...
<div class="form-div">
  <form action="deposit_search_tpl.php" name="searchForm" method="post">

    <img src="../include/images/admin/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
    存款人：
     <input type="text" id="brand_name" name="deposit_name" size="15" value="<?php echo '<?php'; ?>
 echo isset(<?php echo $this->_tpl_vars['name']; ?>
)?<?php echo $this->_tpl_vars['name']; ?>
:'' <?php echo '?>'; ?>
" />&nbsp;&nbsp;
    存款hash:
    <input type="text" id="brand_hash" name="deposit_hash" size="65" value="<?php echo '<?php'; ?>
 echo isset(<?php echo $this->_tpl_vars['hash']; ?>
)?<?php echo $this->_tpl_vars['hash']; ?>
:'' <?php echo '?>'; ?>
" />
