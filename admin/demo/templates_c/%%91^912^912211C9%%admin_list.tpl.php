<?php /* Smarty version 2.6.26, created on 2013-07-31 08:07:59
...
?>
     <tr>
      <td class="first-cell" width="118" align="center">
       <?php echo $this->_tpl_vars['arr']['admin_name']; ?>

       </td>
      <td class="first-cell" width="118" align="center">
       <?php echo $this->_tpl_vars['arr']['password']; ?>

       </td>
      <td align="center" width="118"><?php echo $this->_tpl_vars['arr']['is_delete']; ?>
</td>
      <td align="center" width="118"><?php echo $this->_tpl_vars['arr']['add_user']; ?>
</td>
