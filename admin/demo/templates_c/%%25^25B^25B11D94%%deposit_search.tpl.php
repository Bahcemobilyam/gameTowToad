<?php /* Smarty version 2.6.26, created on 2013-07-31 01:27:56
         compiled from deposit_search.tpl */ ?>
...
<div class="form-div">
  <form action="deposit_search_tpl.php" name="searchForm" method="post">
    ...
    存款人：
     <input type="text" id="brand_name" name="deposit_name" size="15" value="<php> echo isset($name)?$name:'' </php>" />&nbsp;&nbsp;
    存款hash:
    <input type="text" id="brand_hash" name="deposit_hash" size="65" />
