...
.explode {
  background: url(../include/images/admin/menu_minus.gif) no-repeat 0px 3px;
  font-weight: bold;
}
.collapse {
  background: url(../include/images/admin/menu_plus.gif) no-repeat 0px 3px;
  font-weight: bold;
}
.menu-item {
  background: url(../include/images/admin/menu_arrow.gif) no-repeat 0px 3px;
  font-weight: normal;
}
#help-title {
  font-size: 14px;
...
<img id="toggleImg" src="../include/images/admin/menu_minus.gif" width="9" height="9" border="0" alt="闭合" /></a></span>
...
<ul id="menu-ul">
 ...
 取款     <ul>
          <li class="menu-item"><a href="withdrawal_list.php" target="main-frame">取款列表</a></li>
         <!-- <li class="menu-item"><a href="withdrawal_details.php" target="main-frame">取款详情</a></li>-->
          <li class="menu-item"><a href="withdrawal_search.php" target="main-frame">取款查询</a></li>
           <li class="menu-item"><a href="withdrawal_collect.php" target="main-frame">按天汇总</a></li>
       </ul>
      </li>
  <li class="explode" key="10_priv_admin" name="menu">
    存款        <ul>
          <li class="menu-item"><a href="deposit_list.php" target="main-frame">存款列表</a></li>
          <li class="menu-item"><a href="deposit_search.php" target="main-frame">存款查询</a></li>
          <li class="menu-item"><a href="deposit_collect.php" target="main-frame">按天汇总</a></li>
         
        </ul>
  </li>
  <li class="explode" key="02_cat_and_goods" name="menu">用户管理   
       <ul>
          <li class="menu-item"><a href="user_list.php" target="main-frame">用户列表</a></li>
          <li class="menu-item"><a href="" target="main-frame">用户操作</a></li>
       </ul>
   </li>
  <li class="explode" key="02_cat_and_goods" name="menu">后台用户管理   
       <ul>
          <li class="menu-item"><a href="admin_list.php" target="main-frame">用户列表</a></li>
          <li class="menu-item"><a href="admin_add.php" target="main-frame">添加用户</a></li>
       </ul>
   </li>
...
<script type="text/javascript" src="../include/Js/admin/global.js"></script>
<script type="text/javascript" src="../include/Js/admin/utils.js"></script>
...
function toggleCollapse()
{
  ...
  collapse = !collapse;
  document.getElementById('toggleImg').src = collapse ? '../include/images/admin/menu_minus.gif' : '../include/images/admin/menu_plus.gif';
...
Object.extend(ToggleHanlder ,{
  ...
  Load : function()
  {
    ...
    document.getElementById('toggleImg').src = collapse ? '../include/images/admin/menu_minus.gif' : 'images/menu_plus.gif';
    document.getElementById('toggleImg').alt = collapse ? collapse_all : expand_all;
  }
});
